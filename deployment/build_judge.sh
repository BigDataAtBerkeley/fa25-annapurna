...
# Build and deploy Judge Lambda function
...
rm -rf boto3* opensearch_py* requests* certifi* botocore* s3transfer* urllib3* charset_normalizer* idna* six* python_dateutil* Events* jmespath* || true
